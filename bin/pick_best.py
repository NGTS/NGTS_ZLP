...
def pickle_best(chain_name, image, outname, maxlength=1e6):
    ...
    if len(opt) == 12:
        ...
        param_names = ['CRPIX1', 'CRPIX2', 'CD1_1', 'CD2_2', 'CD1_2', 'CD2_1',
                       'PV2_2', 'PV2_3', 'PV2_5', 'PV2_7', 'RA_s', 'DEC_s']
    elif len(opt) == 11:
        # 7th order fit
        dist_map = {
            'CRPIX1': 1.03259815e+03,
        ...
        # 5th order fit
        dist_map = {
            'CRPIX1': 1.03186582e+03,
            'CRPIX2': 9.65390145e+02,
            'CD1_1': 1.41143441e-03,
            'CD2_2': 1.41109881e-03,
            'CD1_2': -1.91498220e-06,
            'CD2_1': 1.57312392e-06,
            'PV2_1': 1.0,
            'PV2_2': 0,
            'PV2_3': 8.71721335e+00,
            'PV2_5': 2.18288567e+02,
            'PV2_7': 0,
            'RA_s': -0.45966596397,
            'DEC_s': 0.48558489999,
            'CTYPE1': 'RA---ZPN',
